...
class ExchangeFactory:
    ...
    def _register_builtin_adapters(self) -> None:
        ...
        try:
            ...
            from .adapters.tradexyz import TradeXYZAdapter
            ...
            self.register_adapter(
                ...
                adapter_class=TradeXYZAdapter,
                exchange_type=ExchangeType.PERPETUAL,
                name="TradeXYZ",
                description="TradeXYZ perpetual and XYZ asset adapter",
                supported_features=[
                    "perpetual_trading", "websocket", "orderbook",
                    "ticker", "ohlcv", "user_data", "xyz_markets"
                ],
                default_config={
                    "testnet": False,
                    "default_leverage": 1,
